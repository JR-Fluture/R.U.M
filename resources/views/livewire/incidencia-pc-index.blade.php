                ...
                <thead>
                    <tr>
                        <th>
                            ...
                            <a href="{{route('incidencias-pcs.index',['condicional'=>'id','orden'=>isset($_SESSION["orden"]) ? $_SESSION['orden'] : 'ASC'])}}" class="text-black flex">
                                ID
                                <?php
                ...
                <tbody>
                    @foreach ($incidencias_pcs as $incidencias_pc)
                        <tr>
                            ...
                            <td>
                                @can('incidencias-pcs.show')
                                    <a class="btn-success btn" href="{{route('incidencias-pcs.show',$incidencias_pc)}}">{{__('Show')}}</a>    
                                @endcan
                            </td>
                            <td>
                                @can('incidencias-pcs.edit')
                                    <a class="btn-primary btn" href="{{route('incidencias-pcs.edit',$incidencias_pc)}}">{{__('Edit')}}</a>    
                                @endcan
                            </td>
                            <td>
                                @can('incidencias-pcs.destroy')
                                <form action="{{route('incidencias-pcs.destroy',compact('incidencias_pc'))}}" method="POST">
                                    @csrf
                                    @method('delete')
