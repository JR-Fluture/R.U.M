        ...
        <div class="card-body">
            <table class="table table-striped">
                <thead>
                    <tr>
                        <th>
                            <a href="{{route('monitores.index',['condicional'=>'id','orden'=>isset($_SESSION["orden"]) ? $_SESSION['orden'] : 'ASC'])}}" class="text-black flex">
                                ID
                                <?php
                        ...
                        <th>
                            <a href="{{route('monitores.index',['condicional'=>'marca','orden'=>isset($_SESSION["orden"]) ? $_SESSION['orden'] : 'ASC'])}}" class="text-black flex">
                                {{__('Marca')}}
                                <?php
                                    if (isset($_SESSION["condicional"])) {
                        ...
                        <th>
                            <a href="{{route('monitores.index',['condicional'=>'modelo','orden'=>isset($_SESSION["orden"]) ? $_SESSION['orden'] : 'ASC'])}}" class="text-black flex">
                                {{__('Model')}}
                                <?php
                                    if (isset($_SESSION["condicional"])) {
                        ...
                        <th>
                            <a href="{{route('monitores.index',['condicional'=>'numero_serie','orden'=>isset($_SESSION["orden"]) ? $_SESSION['orden'] : 'ASC'])}}" class="text-black flex">
                                {{__('NºSerie')}}
                                <?php
                                    if (isset($_SESSION["condicional"])) {
                ...
                <tbody>
                    @foreach ($monitores as $monitor)
                        <tr>
                            ...
                            <td>
                                @can('monitores.show')
                                    <a class="btn-success btn" href="{{route('monitores.show',$monitor)}}">{{__('Show')}}</a>    
                                @endcan
                            </td>
                            <td>
                                @can('monitores.edit')
                                    <a class="btn-primary btn" href="{{route('monitores.edit',$monitor)}}">{{__('Edit')}}</a>    
                                @endcan
                            </td>
                            <td>
                                @can('monitores.destroy')
                                    <form action="{{route('monitores.destroy',compact('monitor'))}}" method="POST">
                                        @csrf
                                        @method('delete')
